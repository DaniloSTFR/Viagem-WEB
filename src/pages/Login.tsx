...
const schema = yup.object({
  ...
  senha: yup
    .string()
    .min(6, " *Informe a senha, ela deve ter ao menos 6 dígitos.")
        ...
        <div className="col-xl-12 aside">
          <div className="row">
            <div className="divtocenter">
              <img src="plane.png" alt="enf.Senior" />{" "}
            </div>
          </div>
          ...
          <div className="row  mb-3 gap-2 col-xl-6  mx-auto">
            <div>
              <p>Viagem WEB</p>
              <p>Sistema para fazer Gestão de Viagens e Diárias</p>
            </div>
          </div>
